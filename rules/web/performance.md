...
id: performance
category: web
description: "Web runtime performance"
globs: "**/*.{css,scss,sass,less,html,tsx,jsx,vue,svelte}"
alwaysApply: false
---

> This file extends [common/performance.md](./common-performance.mdc) with web-specific performance content.
